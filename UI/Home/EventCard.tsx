...
export default function EventCard() {
    return (
        <div className="mx-auto  px-8 py-4 grid grid-cols-3 gap-8 items-start mt-4">
            ...
            <div className="w-full">
                <div className="ml-12 bg-white rounded-xl shadow p-4 flex flex-col items-center space-y-4 ">
